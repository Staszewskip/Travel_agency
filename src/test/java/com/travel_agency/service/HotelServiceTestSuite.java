...
class HotelServiceTestSuite {
    ...
    void deleteHotel() throws HotelNotFoundException {
        Destination destination = new Destination("country", "city", "postcode");
        Destination savedDestination = destinationRepository.save(destination);
        Hotel hotel = new Hotel(1L, "Hotel_name", savedDestination, Collections.emptyList(),100);
        Hotel hotel2 = new Hotel(1L, "Hotel_name", savedDestination, Collections.emptyList(),100);
